...
/**
 * POST → edit a prior user message and re-run from there (D3). Updates the
 * targeted user message's content, truncates everything after it, and
 * re-runs the loop over SSE. Same write-guard as regenerate.
 */
