...
export function PlannerPrioritizeShell() {
  ...
  //                              bulk action)
  //
  // We seed ONCE per planner entry. After the first seed, the user
  // owns the selection — clearing it shouldn't be undone by this
  // effect. `enterPlanner` wipes selectedItemIds to [] on every fresh
  // entry, which remounts this component, so didSeedRef resets too.
