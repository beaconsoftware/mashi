...
/**
 * Re-exported from the server-safe `cursor-serialize.ts` so server
 * code (`loop.ts`) doesn't have to import this client-only file and
 * trigger the "client function from server" runtime error. Callers
 * can keep importing `serializeCursor` from either module.
 */
